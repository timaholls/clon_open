...
$(document).ready(function () {
    ...
    `);
        ...
        fetch(`gpt/api/conversations/${conversationId}/messages/?t=${timestamp}`, {
            method: 'GET',
            headers: {
    ...
    function createNewConversation() {
        ...
        fetchWithAuth('gpt/api/conversations/create/', {
            method: 'POST',
            headers: {
    ...
    function deleteConversation(conversationId) {
        fetchWithAuth(`gpt/api/conversations/${conversationId}/delete/`, {
            method: 'POST',
            headers: {
                'X-CSRFToken': getCookie('csrftoken')
            }
...
// Вспомогательная функция для отправки сообщения на сервер
    function sendMessageToServer(message, conversationId) {
        fetchWithAuth('gpt/api/send_message/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRFToken': getCookie('csrftoken')
